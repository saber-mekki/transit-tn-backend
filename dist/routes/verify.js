...
router.post('/send-code', async (req, res) => {
    try {
        ...
        await (0, sendEmail_1.sendEmail)(email, 'رمز التحقق - Transit TN', `<div style="font-family:sans-serif;max-width:400px;margin:auto;padding:24px;background:#111827;border-radius:12px;">
